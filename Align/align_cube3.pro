...
;
;-
PRO align_cube3, cube, ref, quiet=quiet, shifts=shifts
    ...
    ;-----------------------------------------------------------------
    ;- 17 April 2019
    ;-  aka, the argument was not input by user at all, just, e.g.:
    ;-    align_cube3, cube, quiet=quiet, shifts=shifts
    ;-  works because only kws follow.
    ;-  (trying to work out the difference between original version and this one...)
    ;-----------------------------------------------------------------
