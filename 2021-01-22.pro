...
;-
;- 22 January 2021
;-   Finished extraction of subset "cube" + "index" --> .sav files
;-    (except flare without xcen and ycen values)
;-
;- 13 January 2021
;-
;- Tasks for today:
...
;-----------------------
;-
;- [] better to append index the same way as "cube", so if read_sdo is done
;-  out of order (like if "ind" is not updated), then date_obs and other info
;-  for each image is still preserved, will still match up with proper header.
;- (20 January 2021)
;-
;maxmin, variable
