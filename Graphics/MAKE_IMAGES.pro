...
;-      * 
;-      * 
;- Separate routines that calculate data shown in graphics
;-    from those that actually create the graphic.
...
function IMAGE_ALL_SUBROUTINE, data, title=title, _EXTRA=e
    ...
    ;- Image all of what? I'm guessing this for my reference figures - every other
    ; image in entire time series
